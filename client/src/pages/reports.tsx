                ...
                <div className="space-y-6">
                  <div className="text-center border-b pb-4">
                    <h3 className="text-lg font-semibold">
                      {format(new Date(profitLoss.period.startDate), "MMMM d, yyyy")} - {format(new Date(profitLoss.period.endDate), "MMMM d, yyyy")}
                    </h3>
                  </div>
                  ...
                  <div className="border-t-2 border-gray-300 pt-4">
                    <div className={`flex justify-between text-xl font-bold ${profitLoss.netProfit >= 0 ? 'text-green-600' : 'text-red-600'}`}>
